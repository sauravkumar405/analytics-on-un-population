...
if __name__ == '__main__':
    ...
    print("Enter 3 to view BAR Chart of Total SAARC countries population vs years")
    print("Enter 4 to view Grouped Bar Chart of ASEAN countries population vs years")
